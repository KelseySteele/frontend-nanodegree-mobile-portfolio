...
//"use strict"; //per Udacity review to include this for secure JavaScript.
// As you may have realized, this website randomly generates pizzas.
// Here are arrays of all possible pizza ingredients. I changed all of the meat and cheese ingredients to vegan ingredients :) 
var pizzaIngredients = {};
pizzaIngredients.meats = [
  "Seitan Sausage",
  "Isa's Steamy Beany Sausage",
  "Barbeque Seitan",
  "Smoked Seitan",
  "Barbeque Tempeh",
  "Barbeque Tofu",
...
pizzaIngredients.cheeses = [
  ...
  "Nooch (Nutritional Yeast) Nacho Cheese",
  "Muenster Cheese",
  "Pecan Parmesan",
  "Sunflower Chedder",
  "Tofu Feta",
...
function getAdj(x){
  switch(x) {
    case "kind": 
      var kind = ["kind","compassionate", "planet-saving", "inspiring", "plant-powered", "empathetic", "happy", "generous", "gentle", "amiable", "loving", "benevolent", 
      "altruistic", "benevolent", "friendly", "bright", "considerate", "humanitarian", "gentle", "peaceful", "harmonious", "cozy", 
      "splendid", "nice", "lovely", "caring", "plant-strong", "humane", "chivalrous", "giving", "noble"];
      return kind;
    case "color": 
...
var resizePizzas = function(size) { 
  ...
  var newWidth;  //declare variable since "use strict" added
...
//new function to calculate number of random pizzas on a page based on browser height and width
var numRandomPizzas = function () {
  var h = window.innerHeight; // height of browser screen in pixels without scroll bars.
  var w = window.innerWidth; //width of browser screen in pixels without scroll bars.
  var numPizzas = h/100 * w/73.33; //calculate the number of pizzas based on screen size and size of pizzas.
  return numPizzas;
};

var pizzasDiv = document.getElementById("randomPizzas"); //Create pizzasDiv outside of for loop as suggested by Udacity review
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0; i < numPizzas; i++) {
    ...
    document.getElementById("movingPizzas1").appendChild(elem); //changed above line based on Udacity feedback
  }
  updatePositions();
});
